...
%{
% The averaged form is convenient for regularization (the parameter will not be  
%     necessary change with sampe size ) 

% Zhewei Zhang, 20210304, normalized by the sample size
% L = full(L)/numY; dL = full(dL)/numY; H = full(H)/(numY*numY);
%}
