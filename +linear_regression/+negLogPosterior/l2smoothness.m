function [negLP,grad,H] = l2smoothness(prs, negloglifun, beta, num_reg)
...
switch nargout
    ...
    case 1  % evaluate function
        negLP = negloglifun(prs) + prs_diff'*prs_diff*beta;
    
    case 2  % evaluate function and gradient
        [negLP,grad] = negloglifun(prs);
        negLP = negLP + prs_diff'*prs_diff*beta;        
        grad  = grad  + 2*beta*add_grad;
